            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <section>
                        ...
                        <form method="POST" action="{{ route('client.update', $client->id) }}" enctype="multipart/form-data" class="mt-6 space-y-6">
                            @csrf
                            {{-- @method('PUT')  --}}
                            <!-- Name Field -->
                            <div>
                            ...
                            <div class="mt-4">
                                ...
                                <img src="{{ url($client->image_path) }}" alt="Client Image" style="width:150px; height:auto;">
                            </div>
