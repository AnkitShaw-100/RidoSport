            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <section>
                        ...
                        <form method="POST" action="{{ route('certificate.update', $certificate->id) }}" enctype="multipart/form-data" class="mt-6 space-y-6">
                            @csrf
                            {{-- @method('PUT') <!-- Use PUT method for updating the certificate --> --}}

                            <!-- Certified By Company Name -->
                            <div>
                                <x-input-label for="certified_by_company_name" :value="__('Certified By Company Name')" />
                                <x-text-input id="certified_by_company_name" name="certified_by_company_name" type="text" class="mt-1 block w-full" :value="old('certified_by_company_name', $certificate->certified_by_company_name)" required autofocus autocomplete="certified_by_company_name" />
                            ...
                            <div>
                                ...
                                <x-text-input id="certified_for" name="certified_for" type="text" class="mt-1 block w-full" :value="old('certified_for', $certificate->certified_for)" required autofocus autocomplete="certified_for" />
                            ...
                            <div>
                                ...
                                <x-text-input id="product_name" name="product_name" type="text" class="mt-1 block w-full" :value="old('product_name', $certificate->product_name)" required autofocus autocomplete="product_name" />
                                <x-input-error class="mt-2" :messages="$errors->get('product_name')" />
                            </div>

                            <!-- Current Certified By Logo -->
                            <div class="mt-4">
                                <x-input-label for="current_certified_by_logo" :value="__('Current Certified By Logo')" />
