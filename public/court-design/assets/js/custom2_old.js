...
$(document).ready(function(){
   ...
   var element = $("#colorbig").html(); // global variable
    var getCanvas; // global variable
    $("#btn-Preview-Image").on('click', function () {
        html2canvas($("#colorbig")[0]).then(function(canvas) {
...
// // Show the form before download
// $("#btn-Preview-Image").on('click', function () {
//     $("#downloadModal").show(); // Show the form modal
// });
...
//     // Send form data via email (you'll need a backend service for this)
//     $.ajax({
//         type: "POST",
//         url: "your-server-url-to-send-email",  // This URL should handle the email sending
//         data: {
//             name: name,
//             email: email,
//             phone: phone,
...
//         },
//         success: function () {
//             $("#downloadModal").hide(); // Hide the form modal
//             $("#thankYouMessage").show(); // Show the thank you message

//             // After 2 seconds, trigger the download
//             setTimeout(function () {
//                 $("#thankYouMessage").hide(); // Hide the thank you message

//                 // Proceed to image download
//                 html2canvas($("#colorbig")[0]).then(function (canvas) {
//                     var imgageData = canvas.toDataURL("image/png");
//                     var newData = imgageData.replace(/^data:image\/png/, "data:application/octet-stream");
//                     var a = $("#btn-Convert-Html2Image").attr("download", "your_court.png").attr("href", newData);
//                     a[0].click();
//                 });
//             }, 2000); // 2 seconds delay before download starts
//         }
//     });
// });
