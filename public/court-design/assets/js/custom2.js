...
$(document).ready(function(){
     $('input[type="checkbox"]').click(function(){
        ...
        if(classname==='custom-checkbox border') {
            ...
            if ($('input[class="custom-checkbox border"]').is(':checked')) {
                ...
                $('#colorbig').css('background-color', '#a04647');
            ...
            if($('input[class="custom-checkbox surface"]').is(':checked')){
                ...
                $('#colorbig img').css('background-color','#0078be');
            }
        }else if(classname==='custom-checkbox inner'){
             $('input[class="custom-checkbox inner"]').not(this).prop('checked', false);
                if($('input[class="custom-checkbox inner"]').is(':checked')){
                      $('#default').hide();
                       $('.fut').hide();
                      ...
                      $("#" + inputValue).show();
                       ...
                       $('#default_left-court').hide();
                        var inputValue = $(this).attr("value");
                       $("#" + inputValue +"-left-court").show();
                     

                 }
         }else if(classname==='custom-checkbox circle'){
             $('input[class="custom-checkbox circle"]').not(this).prop('checked', false);
                if($('input[class="custom-checkbox circle"]').is(':checked')){
                       $('#default').hide();
                       $('.futcir').hide();
                       $('#default-left-mid-circle').hide();
                      
                        var inputValue = $(this).attr("value");

                       $("#" + inputValue).show();
                       $('#' +inputValue+' img').css('background-color','');
   ...
   var element = $("#main_div").html(); // global variable
  ...
  $('input[name="grass"]').click(function(){
      if($('input[name="grass"]').is(':checked')){
          $('.surface-box').hide();
          $('.surface-evergreen').show();

          $('#default').hide();
          $('#handball-evergreen-key').show();
          $('#handball-evergreen-key img').css('background-color','#009246');
          $('#colorbig').css('background-color','#009246');

         $('#handball-evergreen-key-left-court').show();
         $('#border-evergreen box border-box').show();
         ...
         //$('input[name="volleyballCheckbox"]').prop("disabled", true);
         $('.custom-checkbox border').prop("disabled", true);
         $('.custom-checkbox inner').prop("disabled", true);
       }else{
         location.reload();
       }
